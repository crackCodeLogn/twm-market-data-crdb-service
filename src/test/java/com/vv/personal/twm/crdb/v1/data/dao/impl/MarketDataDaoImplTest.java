...
class MarketDataDaoImplTest {
  ...
  @InjectMocks private MarketDataDaoImpl marketDataDaoImpl;
  ...
  public void testGetMarketDataByTicker() {
    ...
    Optional<MarketDataProto.Ticker> optionalTicker =
        marketDataDaoImpl.getMarketDataByTicker("cm.to");
    ...
    optionalTicker = marketDataDaoImpl.getMarketDataByTicker("vfv.to");
    System.out.println(optionalTicker);
  ...
  public void testGetEntireMarketData() {
    ...
    Optional<MarketDataProto.Portfolio> optionalPortfolio = marketDataDaoImpl.getEntireMarketData();
